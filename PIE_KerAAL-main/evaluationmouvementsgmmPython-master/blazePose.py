...
file_to_write=open("resultats/SkeletonSequence1.txt","w+") #Where to write results

mode="video" #camera / video 
videoFile='data/Video/cacheTete/sub01_trial01/VideoColor_Correct1.avi' #For video input, if mode=="video"
...
def draw_landmarks_of_poppy(cord):
  skeleton_line = [[0,1],[1,20],[20,2],[2,3],
  ...
  if processAllVideos :
    ...
    with mp_pose.Pose(
      ...
      while cap.isOpened():
        ...
        # cv2.imwrite('resultats/video_image' + str(frame) + '.png', image)
